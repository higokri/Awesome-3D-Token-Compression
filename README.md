...
| **CoverPrune** | ![ECCV 2026](https://img.shields.io/badge/ECCV-2026-blue) ![Spotlight](https://img.shields.io/badge/Spotlight-2ea44f) <br>[Coverage-Driven Token Pruning for 3D VLMs via Optimal Transport](https://arxiv.org/abs/2608.13226) <br><sub>Peng Ling et al.</sub> | GS-Reasoner · VLM-3R | 🔒 |
